...
<title>sidebar</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/gnb/sidebar.css">
<link rel="stylesheet"
...
<body>
		<div class="menu-box">
			<div class="logo">
				...
				<div class="logo-circle"><img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="logo"></div>
					<p>TRAINERBOT</p></a>
			</div>
			<ul class="menu-bar">
