...
<body>
	...
	<a
		href="${pageContext.request.contextPath}/member/ExerciseJournalUpdate?exerciseCode=${exerciseCode}">수정</a>
	<a
		href="${pageContext.request.contextPath}/member/ExerciseJournalDel?exerciseCode=${exerciseCode}">삭제</a>
</body>
</html>