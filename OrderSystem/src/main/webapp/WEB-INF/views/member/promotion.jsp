...
var freeTitle = document.form1.freeTitle.value;
var freeContext = document.form1.freeContext.value;

if(freeTitle == ""){
alert("제목을 입력하세요.");
document.form1.freeTitle.focus();
return;
};
...
<body>
 <div class="allContents">
	...
	<input type="hidden" id="thum" value="default" name="thumbnail">
		...
		<div class="freeTitle">
			<label>이름 &nbsp;&nbsp;</label> <input type="text" name="name" placeholder="이름을 입력해주세요." style="width:620px" onkeyup="chkword(this,40)">
			<label>성별 &nbsp;&nbsp;</label> <input type="text" name="sex" placeholder="성별을 입력해주세요." style="width:620px" onkeyup="chkword(this,40)">
			<label>경력 &nbsp;&nbsp;</label> <input type="text" name="career" placeholder="경력을 입력해주세요." style="height: 420px; width:620px;" onkeyup="chkword(this,40)">
...
<div class="filebox bs3-primary preview-image" onchange="dropfile();">
			<label for="input_file">파일 선택</label> 
                            <input class="upload-name" value="" disabled="disabled" style="width: 200px;">

                            
                          <input multiple="multiple" type="file" id="input_file" class="upload-hidden" name="attach" > 
		...
		<div class="alarm-box"><p class="alarm">첨부파일은 최대 40mb까지 등록이 가능하며 <br>파일 형식은 jpg,gif,psd,png,tif,zop,ms office,아래한글(hwp),pdf,excel,zip,7z만 가능합니다.</div>
	</div>
		

		<div class="Btn">
			<button type="button" id="btnSubmit" class="regiserBtn" onclick="getThumbnail()">등록</button>
